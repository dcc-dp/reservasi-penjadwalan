                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                <td class="ps-3">{{ $item->materi->Judul ?? '-' }}</td>
                                                <td>{{ $item->jenis }}</td>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="hapusPaketLabel{{ $item->id }}">
                                                                Hapus Paket</h1>
...
>>>>>>> 4ab81a367051265b4b0c890861d71095d42e89e1
                </div>
            </div>
        </div>
    </main>
