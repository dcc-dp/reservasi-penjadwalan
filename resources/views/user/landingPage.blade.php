        ...
        <div class="container-fluid pb-5 hero-header bg-light mb-5">
            <div class="container py-5">
                <div class="row g-5 align-items-center mb-5">
                    <div class="col-lg-6">
                        <h1 class="display-1 mb-4 animated slideInRight">Tingkatkan Skill Programming! <span
                                class="text-primary"></span></h1>
                        <h5 class="d-inline-block border border-2 border-white py-3 px-5 mb-0 animated slideInRight">
                            Daftar Sekarang, Kuasai Programming!</h5>
                    </div>
                    <div class="col-lg-6">
                        <div class="owl-carousel header-carousel animated fadeIn">
                            <img class="img-fluid" src="{{ asset('assets/user/img/hero-slider-1.jpg') }}" alt="">
                            <img class="img-fluid" src="{{ asset('assets/userimg/hero-slider-2.jpg') }}" alt="">
                            <img class="img-fluid" src="{{ asset('assets/userimg/hero-slider-2.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-6 wow fadeIn" data-wow-delay="0.1s">
                                <img class="img-fluid" src="{{ asset('assets/user/img/pic1.jpg') }}" alt="">
                            </div>
                            <div class="col-6 wow fadeIn" data-wow-delay="0.3s">
                                <img class="img-fluid h-75" src="{{ asset('assets/user/img/pic22.jpg') }}" alt="">
                                <div class="h-25 d-flex align-items-center text-center bg-primary px-4">
                                    <h4 class="text-white lh-base mb-0">Belajar Program</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-5"><span class="text-uppercase text-primary bg-light px-2">Sejarah Kami</span>
                        </h1>
                        <p class="mb-4">TKami hadir untuk membantu kamu belajar programming dengan mudah dan praktis.
                            Dari pemula hingga mahir, setiap kursus dirancang agar kamu cepat paham dan siap praktek. Tim
                            kami berdedikasi untuk memastikan pengalaman belajar kamu menyenangkan dan efektif.</p>
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <h6 class="mb-3"><i class="fa fa-check text-primary me-2"></i>Instruktur Profesional
                                </h6>
                                <h6 class="mb-0"><i class="fa fa-check text-primary me-2"></i>Bantuan 24/7</h6>
                            </div>
                            <div class="col-sm-6">
                                <h6 class="mb-3"><i class="fa fa-check text-primary me-2"></i>Kursus Bersertifikat</h6>
            ...
            <div class="container">
                ...
                <div class="row g-5 align-items-center text-center">
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <p class="mb-0">Kami berpengalaman lebih dari 25 tahun dalam dunia pendidikan dan teknologi, siap
                            membimbingmu dari dasar hingga mahir.</p>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                        <i class="fa fa-tasks fa-5x text-primary mb-4"></i>
                        <h5>Best Learning Method</h5>
                        <p class="mb-0">Materi disusun dengan metode belajar interaktif agar mudah dipahami dan
                            diterapkan dalam proyek nyata.</p>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                        <i class="fa fa-pencil-ruler fa-5x text-primary mb-4"></i>
                        <h5>Innovative Instructors</h5>
                        <p class="mb-0">Dibimbing langsung oleh mentor berpengalaman dan praktisi industri IT yang siap
                            berbagi wawasan terbaru.</p>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                        <i class="fa fa-user fa-5x text-primary mb-4"></i>
                        <h5>Student Satisfaction</h5>
                        <p class="mb-0">Kepuasan peserta adalah prioritas kami. Belajar santai, interaktif, dan hasilnya
                            nyata.</p>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                        <i class="fa fa-hand-holding-usd fa-5x text-primary mb-4"></i>
                        <h5>Budget Friendly</h5>
                        <p class="mb-0">Kursus terjangkau dengan kualitas premium. Belajar coding tak harus mahal!</p>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                        <i class="fa fa-check fa-5x text-primary mb-4"></i>
                        <h5>Continuous Support</h5>
                        <p class="mb-0">Dapatkan dukungan dan bimbingan berkelanjutan, bahkan setelah kursus selesai.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-0">
                    <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                        <div class="d-flex flex-column justify-content-center bg-primary h-100 p-5">
                            <h1 class="text-white mb-5">Kursus Terbaru Kami <span
                                    class="text-uppercase text-primary bg-light px-2"></span></h1>
                            <h5 class="text-white mb-0"> Jelajahi kursus terbaru kami dan pilih program yang sesuai untuk
                                meningkatkan skill coding-mu. Dari pemula hingga mahir, semuanya siap membantumu belajar
                                lebih efektif.</h5>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.2s">
                                <div class="project-item position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="{{ asset('assets/user/img/project1.jpeg') }}"
                                        alt="">
                            ...
                            <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.4s">
                                <div class="project-item position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="{{ asset('assets/user/img/project1.jpeg') }}"
                                        alt="">
                                    <a class="project-overlay text-decoration-none" href="#!">
                                        <h4 class="text-white">Framework</h4>
                            ...
                            <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                                <div class="project-item position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="{{ asset('assets/user/img/project1.jpeg') }}"
                                        alt="">
                                    <a class="project-overlay text-decoration-none" href="#!">
                                        <h4 class="text-white">Algoritma</h4>
                            ...
                            <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.6s">
                                <div class="project-item position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="{{ asset('assets/user/img/project1.jpeg') }}"
                                        alt="">
                                    <a class="project-overlay text-decoration-none" href="#!">
                                        <h4 class="text-white">Proyek Mini Coding</h4>
                            ...
                            <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.7s">
                                <div class="project-item position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="{{ asset('assets/user/img/project1.jpeg') }}"
                                        alt="">
                                    <a class="project-overlay text-decoration-none" href="#!">
                                        <h4 class="text-white">Belajar Dasar Coding</h4>
                        ...
                        <div class="row g-0">
                            <div class="col-md-6 wow fadeIn" data-wow-delay="0.2s">
                                <div class="service-item h-100 d-flex flex-column justify-content-center bg-primary">
                                    <a href="#!" class="service-img position-relative mb-4">
                                        <img class="img-fluid w-100" src="{{ asset('assets/user/img/service-1.jpg') }}"
                                            alt="">
                                        <h3>Pemula</h3>
                                    </a>
                            ...
                            <div class="col-md-6 wow fadeIn" data-wow-delay="0.4s">
                                <div class="service-item h-100 d-flex flex-column justify-content-center bg-light">
                                    <a href="#!" class="service-img position-relative mb-4">
                                        <img class="img-fluid w-100" src="{{ asset('assets/user/img/service-2.jpg') }}"
                                            alt="">
                                        <h3>Implementasi Projek</h3>
                                    </a>
                                    <p class="mb-0">Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed
                                        diam
                                        stet diam sed stet lorem.</p>
                            ...
                            <div class="col-md-6 wow fadeIn" data-wow-delay="0.6s">
                                <div class="service-item h-100 d-flex flex-column justify-content-center bg-light">
                                    <a href="#!" class="service-img position-relative mb-4">
                                        <img class="img-fluid w-100" src="{{ asset('assets/user/img/service-3.jpg') }}"
                                            alt="">
                                        <h3>Lanjutan</h3>
                                    </a>
                                    <p class="mb-0">Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed
                            ...
                            <div class="col-md-6 wow fadeIn" data-wow-delay="0.8s">
                                <div class="service-item h-100 d-flex flex-column justify-content-center bg-primary">
                                    <a href="#!" class="service-img position-relative mb-4">
                                        <img class="img-fluid w-100" src="{{ asset('assets/user/img/service-4.jpg') }}"
                                            alt="">
                                        <h3>Kursus Profesional</h3>
                                    </a>
                                    <p class="mb-0">Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed
                                        diam
                                        stet diam sed stet lorem.</p>
                    ...
                    <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                        <div class="team-item position-relative overflow-hidden">
                            ...
                            <div class="team-overlay">
                                ...
                                <h4 class="lh-base text-light">{{ $profile->user->id ?? '-' }}</h4>
