                    ...
                    <tbody>
                        ...
                        @forelse ($kursusList as $index => $kursus)
                            ...
                            <tr class="border-t border-zinc-100 hover:bg-zinc-50 transition">
                                ...
                                <td class="text-muted px-5 py-4 text-center max-w-xs" style="font-size:10px;">
                                    {{ \Illuminate\Support\Str::limit($kursus->deskripsi, 50) }}
                                </td>
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="{{ route('kursus.destroy', $kursus->id) }}" method="POST">
                                            ...
                                            <button type="submit" onclick="return confirm('Yakin hapus kursus ini?')"
