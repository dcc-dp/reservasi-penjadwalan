        ...
        <form
            ...
            <div>
                ...
                <textarea
                    ...
                    class="w-full rounded-xl border border-zinc-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-900">{{ old('deskripsi', $materi->deskripsi) }}</textarea>
