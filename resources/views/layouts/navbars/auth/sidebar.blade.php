    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                @if (Auth::user()->role == 'admin')
                    <li class="nav-item mt-3">
                        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Manajemen Reservasi
                        </h6>
                    </li>
                    <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('profile-instruktur') ? 'active' : '' }}"
                        href="{{ url('profile-instruktur') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Profile Instruktur</span>
                    </a>
                </li>
                <li class="nav-item">
        ...
        <a class="nav-link  " href="{{ url('static-sign-up') }}">
          ...
          <span class="nav-link-text ms-1">Sign Up</span>
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="m-0 p-0">
                        @csrf
                        <button type="submit"
                            class="nav-link btn w-100 text-start text-dark border-0 bg-transparent">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 46 42"
                                    ...
                                    <g fill="none" fill-rule="evenodd">
                                        <path class="color-background opacity-6"
                                            d="M29 0H4C1.79 0 0 1.79 0 4v34c0 2.21 1.79 4 4 4h25c2.21 0 4-1.79 4-4V27h-4v11H4V4h25v11h4V4c0-2.21-1.79-4-4-4z"
                                            fill="#000000" />
                                        <path class="color-background"
                                            d="M33 14l-2.83 2.83L35.34 22H16v4h19.34l-5.17 5.17L33 34l9-9z"
                                            fill="#000000" />
                                    </g>
                                </svg>
                            </div>
...
@if (Auth::user()->role == 'siswa')
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
                aria-hidden="true" id="iconSidenav"></i>
            <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('siswa.dashboard') }}">
                <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="...">
                <span class="ms-3 font-weight-bold">Soft UI Dashboard Laravel</span>
            </a>
        </div>
