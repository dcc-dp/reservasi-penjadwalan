                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form text-left" method="POST" action="/register">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Notelp" name="notelp" id="notelp"
                                        aria-label="Notelp" aria-describedby="Notelp-addon" value="{{ old('notelp') }}">
                                    @error('notelp')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Alamat" name="alamat" id="alamat"
                                        aria-label="Alamat" aria-describedby="Alamat-addon" value="{{ old('alamat') }}">
                                    @error('alamat')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
